...
void init() {
	...
	{
		printf("%d Filling tables lpm_table/sendout_table PORT: %d MAC: %02x:%02x:%02x:%02x:%02x:%02x IP: %d.%d.%d.%d\n", i, portmap[i], macs[i][0],macs[i][1],macs[i][2],macs[i][3],macs[i][4],macs[i][5], ips[i][0],ips[i][1],ips[i][2],ips[i][3]);
